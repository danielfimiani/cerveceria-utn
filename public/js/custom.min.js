!(function () {
  ...
  var e = {
    ...
    r = function (e) {
      for (
        var t = function (e) {
            for (var t, n, a, i, r = e.childNodes, o = r.length, s = [], u = 0; u < o; u++)
              1 === (t = r[u]).nodeType &&
                ((n = t.children[0]),
                console.log(t),
                (a = n.getAttribute("data-size").split("x")),
                (i = { src: n.getAttribute("href"), w: parseInt(a[0], 10), h: parseInt(a[1], 10) }),
        ...
        i[r].setAttribute("data-pswp-uid", r + 1),
          (i[r].onclick = function (e) {
            ...
            if (i) {
              for (
                var r, o = i.parentNode, s = i.parentNode.childNodes, u = s.length, l = 0, d = 0;
                d < u;
                d++
              )
                if (1 === s[d].nodeType) {
